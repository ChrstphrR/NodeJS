...
to rely on a third-party library such as [async](http://npm.im/async) 
or [after](http://npm.im/after). But for this exercise, try and do it 
...
var theURLs = process.argv.slice(2, process.argv.length);
var Counter = 0;
var thePages = [];


function printResults() {
	for (index in thePages) {
		console.log(thePages[index]);
	}
}
...
//main code -- send requests!
for (index in theURLs) {
	fetchURL(index);
}


//how do I tell the http requests are all done??? :(
